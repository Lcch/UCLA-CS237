...
tests(JS,
  ...
  {
    name: 'test1',
    code: 'OO.declareClass("TestClass", "Object", ["testVariable"]); \n' +
          'OO.declareMethod("TestClass", "testMethod", function(_this) { return 1; }); \n' + 
          'OO.declareClass("TestSubClass", "TestClass", []); \n' + 
          'OO.declareMethod("TestSubClass", "testMethod", function(_this) { return 2;}); \n' +
          'OO.declareClass("TestSubSubClass", "TestSubClass", []); \n' +
          'OO.superSend("TestClass", OO.instantiate("TestSubSubClass"), "testMethod");',
    expected: 1
  },
  {
    name: 'test1',
    code: 'OO.superSend("Nonexistant", OO.instantiate("TestSubClass"), "testMethod");',
    shouldThrow: true
  },
  {
    name: 'test1',
    code: 'OO.setInstVar(OO.instantiate("TestClass", 1), "testVariable", 2);',
    expected: 2
  }
);
